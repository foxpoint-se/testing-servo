# usage: python gpio_udev_setup.py <username> <group>
# eg: python gpio_udev_setup.py ubuntu gpio
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "group", type=str, default="gpio", help="specify name of gpio control group"
    )
